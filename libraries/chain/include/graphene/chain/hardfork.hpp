...
#endif
// core issue #922 Missing checks when updating an asset's bitasset_data
// core issue #931 Changing backing asset ID runs some checks against the old value instead of the new
...
#endif
// core issue #935 Call check_call_orders not only when settlement_price changed
