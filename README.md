...
`master` | `develop`  
 --- | --- | --- | --- | ---
 [![master](https://github.com/hlht/core/master)](https://github.com/hlht/core) | [![develop](https://github.com/hlht/core/tree/develop)](https://github.com/hlht/core)
...
Chain Core is the Chain blockchain implementation and command-line interface.
PLUS Chain is developed based on graphene, namely the project of Chain. We have made our own consensus mechanism, aka D-DPoS, in brief a contribution-based and relatively randomized super-node election mechanism, in order to avoid ballot rigging and improve security. Also, we have implemented our own virtual machine (which is not included in Chain) for smart contracts, which is also compatible with Solidarity, the most popular Ethereum smart contract language.
The web wallet is [Chain UI](https://github.com/hlht/ui).

**NOTE:** The official Chain git repository location, default branch, and submodule remotes were recently changed. Existing
repositories can be updated with the following steps:

    git remote set-url origin https://github.com/hlht/core.git
    git checkout master
...
Chain Core bugs can be reported directly to the [issue tracker](https://github.com/my-graphene/core/issues).

Chain UI bugs should be reported to the [UI issue tracker](https://github.com/my-graphene/ui/issues)
...
Here is an example using `wscat` package from `npm` for websockets:
    ...
    < {"id":1,"result":[{"id":"1.2.0","annotations":[],"membership_expiration_date":"1969-12-31T23:59:59","registrar":"1.2.0","referrer":"1.2.0","lifetime_referrer":"1.2.0","network_fee_percentage":2000,"lifetime_referrer_fee_percentage":8000,"referrer_rewards_percentage":0,"name":"committee-account","owner":{"weight_threshold":1,"account_auths":[],"key_auths":[],"address_auths":[]},"active":{"weight_threshold":6,"account_auths":[["1.2.5",1],["1.2.6",1],["1.2.7",1],["1.2.8",1],["1.2.9",1],["1.2.10",1],["1.2.11",1],["1.2.12",1],["1.2.13",1],["1.2.14",1]],"key_auths":[],"address_auths":[]},"options":{"memo_key":"PLUS1111111111111111111111111111111114T1Anm","voting_account":"1.2.0","num_witness":0,"num_committee":0,"votes":[],"extensions":[]},"statistics":"2.7.0","whitelisting_accounts":[],"blacklisting_accounts":[]}]}
...
about API's for the [witness node](https://token.github.io/doxygen/namespacegraphene_1_1app.html) and the
[wallet](https://token.github.io/doxygen/classgraphene_1_1wallet_1_1wallet__api.html).
If you want information which is not available from an API, it might be available
from the [database](https://token.github.io/doxygen/classgraphene_1_1chain_1_1database.html);
...
* What is the meaning of `a.b.c` numbers?
    ...
    [types.hpp](https://github.com/my-graphene/core/blob/master/libraries/chain/include/graphene/chain/protocol/types.hpp).
...
Chain Core is under the MIT license. See [LICENSE](https://github.com/my-graphene/core/blob/master/LICENSE.txt)
